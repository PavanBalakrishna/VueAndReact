# This will import all the widgets and modules which are available in tkinter
from tkinter import * 
import serial
...
def getData():                         #Function to get the data from the Arduino Serial port
    ...
    return arduinoData
def scanProcess():
    scannedData=getData()                          #Data that gets scanned by the RFID i.e the SRN, now we need to check
                                                   #if this SRN is present within the list of SRNS ie listofSRN
